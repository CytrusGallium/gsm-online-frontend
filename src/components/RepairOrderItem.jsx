  ...
  return (
    <div className='w-full sm:w-4/5 flex flex-row flex-wrap items-center justify-center border-2 border-gray-300 mt-4 mb-4 py-2 rounded-lg bg-gray-900'>
      ...
      <div className='border border-gray-500 text-gray-100 m-2 p-2 w-full rounded-lg'>
        ...
        <br />
        <input type="number" name="estPrice" placeholder="Prix estimé..." value={itemState.estPrice} onChange={handleChange} className={inputFieldStyle3rd} readOnly={((itemState.problems && itemState.problems.length > 1) ? true : false)} />
        ...
        <br />
        <input type="number" name="price" placeholder="Prix final..." value={itemState.price} onChange={handleChange} className={inputFieldStyle3rd} />
      </div>
      <br />
