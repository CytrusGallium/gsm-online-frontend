...
const RepairOrderValidationPopupV2 = (props) => {
    ...
    return (
        <div className='bg-black bg-opacity-60 backdrop-blur fixed top-0 w-screen h-screen z-10 flex flex-col items-center justify-center'>

            <motion.div className='bg-gray-100 border-4 border-gray-700 border-b-0 rounded-t-xl h-8 flex flex-row items-center justify-center text-gray-900 text-sm font-bold'
                style={{ width: "80%" }}
                initial={{ opacity: 0, y: "-50%" }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, delay: 0.25 }}
            >
                <div className='flex-1'>Validation de l'Ordre de Réparation</div>
                <div><FaTimesCircle size={20} className='mr-1 cursor-pointer hover:text-gray-700' onClick={CloseModal} />
                    <ReactHotkeys
                        keyName="Escape"
            ...
            <motion.div className='bg-gray-900 border-4 border-gray-700 rounded-b-xl flex flex-col items-center justify-center overflow-auto scrollbar shadow-[0_15px_16px_-5px_rgba(0,0,0,0.9)]'
...
export default RepairOrderValidationPopupV2